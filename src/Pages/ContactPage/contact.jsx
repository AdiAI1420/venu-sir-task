  ...
  return (
    <>
      <div className="banner-card mt-5">
        <img
          src="https://insemitech.com/wp-content/uploads/2022/05/contact-banner.jpg"
          className="banner"
        />
        ...
        <div className="row">
          <div className="col-sm-4">
            <div className="whatWeDoItem text-center">
              <img
                decoding="async"
                src="https://insemitech.com/wp-content/uploads/2022/05/contact-12.png"
              />
              <h4>Business Query</h4>
              <a href="mailto:business@insemitech.com">
                business@soc circuits.com
              </a>
            </div>
          </div>
          <div className="col-sm-4">
            <div className="whatWeDoItem text-center">
              <img
                decoding="async"
                src="https://insemitech.com/wp-content/uploads/2022/05/contact-13.png"
              />
              <h4>Careers</h4>
              <a href="mailto:careers@insemitech.com">
                careers@soccircuits.com
              </a>
            </div>
          </div>
          <div className="col-sm-4">
            <div className="whatWeDoItem text-center">
              <img
                decoding="async"
                src="https://insemitech.com/wp-content/uploads/2022/05/contact-14.png"
              />
              <h4>PR / Marketing</h4>
              <a href="mailto:marketing@soccircuits.com">
                marketing@soccircuits.com
              </a>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <img
          src="https://insemitech.com/wp-content/uploads/2022/07/map.png"
          className="map"
      ...
      <div className="form-container">
        ...
        <div className="form-group">
          ...
          <input
            type="email"
            className="form-control lengthbox"
            id="Business_Email"
            name="Business_Email"
